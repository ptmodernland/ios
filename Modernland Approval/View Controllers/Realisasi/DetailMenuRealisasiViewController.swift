...
class DetailMenuRealisasiViewController: BaseViewController, UITextFieldDelegate, UITextViewDelegate {
    ...
    @IBOutlet weak var lblNoKasbon: UILabel!
    ...
    @IBOutlet weak var lblTxtNoKasbon: UILabel!
    ...
    @IBOutlet var detailViewRealisasi: UIView!
    ...
    func configScreen(){
        if (self.view.frame.width == 320) {
            ...
            self.lblNoKasbon.font = UIFont(name: self.lblNoKasbon.font.fontName, size: 12)
            self.lblTxtNoKasbon.font = UIFont(name: self.lblTxtNoKasbon.font.fontName, size: 12)
            ...
            self.detailViewRealisasi.layoutIfNeeded()
            ...
            self.lblNoKasbon.font = UIFont(name: self.lblNoKasbon.font.fontName, size: 14)
            self.lblTxtNoKasbon.font = UIFont(name: self.lblTxtNoKasbon.font.fontName, size: 14)
            ...
            self.lblNoKasbon.font = UIFont(name: self.lblNoKasbon.font.fontName, size: 16)
            self.lblTxtNoKasbon.font = UIFont(name: self.lblTxtNoKasbon.font.fontName, size: 16)
            self.lblTxtDepartemen.font = UIFont(name: self.lblTxtDepartemen.font.fontName, size: 16)
            ...
            self.lblNoKasbon.font = UIFont(name: self.lblNoKasbon.font.fontName, size: 18)
            self.lblTxtNoKasbon.font = UIFont(name: self.lblTxtNoKasbon.font.fontName, size: 18)
            self.lblTxtDepartemen.font = UIFont(name: self.lblTxtDepartemen.font.fontName, size: 18)
            ...
            self.lblNoKasbon.font = UIFont(name: self.lblNoKasbon.font.fontName, size: 25)
            self.lblTxtNoKasbon.font = UIFont(name: self.lblTxtNoKasbon.font.fontName, size: 25)
            self.lblTxtDepartemen.font = UIFont(name: self.lblTxtDepartemen.font.fontName, size: 25)
            self.myConstraint1.constant = 350
            self.myConstraint2.constant = 350
            self.myConstraint3.constant = 350
    ...
    func getApiDetail() {
        ...
        vm.getDetailRealisasi(
            ...
            onSuccess: { response in
                ...
                self.lblNoKasbon.text = response.no_kasbon ?? "";
    ...
    func apiApproveRealisasi(pin: String) {
        let idUser = UserDefaults().string(forKey: "idUser")
        let macAddress = UIDevice().identifierForVendor?.uuidString ?? ""
        
        let param = [
            "idRealisasi" : self.idRealisasi,
            "noKasbon" : self.lblNoKasbon.text ?? "",
            "noRealisasi" : self.lblNomor.text ?? "",
            "id_user" : idUser ?? "",
    ...
    func apiRejectRealisasi(pin: String) {
        let idUser = UserDefaults().string(forKey: "idUser")
        let macAddress = UIDevice().identifierForVendor?.uuidString ?? ""
    ...
    func callAlertTextBox(type: String) {
        ...
        alert.addAction(UIAlertAction(title: "OK", style: .default, handler: { [weak alert] (_) in
            ...
            if type == "Approve" {
                self.apiApproveRealisasi(pin: textField?.text ?? "")
            } else {
                self.apiRejectRealisasi(pin: textField?.text ?? "")
            }
        }))
    ...
    @IBAction func buttonDetailWebviewTap(_ sender: Any) {
        ...
        vc.url = "https://approval.modernland.co.id/realisasi/view_mobile/\(idRealisasi)"
...
extension DetailMenuRealisasiViewController : QLPreviewControllerDataSource {

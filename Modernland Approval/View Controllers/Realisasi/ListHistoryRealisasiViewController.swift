...
class ListHistoryRealisasiViewController: BaseViewController {
...
extension ListHistoryRealisasiViewController: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.lblNomor.text = listRealisasi[indexPath.row].no_kasbon

...
class ListKasbonViewController: BaseViewController {
    ...
    func getListKasbon() {
        ...
        vm.postListKasbon(
            ...
            onSuccess: { response in
                ...
                for kasbon in response {
                    self.listKASBON.append(kasbon)
                }
...
extension ListKasbonViewController: UITableViewDelegate, UITableViewDataSource {
